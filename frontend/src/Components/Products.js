...
export default function Products() {
  return (
    ...
    <div className='row row-cols-3"'>
        ...
        <div class="col">
        <Card title={"White Printed Coffee Mug"} description={"Rs 300 | 4.0"} imageUrl={"https://images.unsplash.com/photo-1542556398-95fb5b9f9b48?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} InfoUrl={""}/>
        </div>
        <div class="col">
    ...
    <div className='row row-cols-3"'>
        ...
        <div class="col">
        <Card title={"Summer Military Pattern T-shirt"} description={"Rs 399 | 4.9"} imageUrl={"https://images-cdn.ubuy.co.in/65f8460808a4753e900af712-men-s-us-united-states-army-camoflauge.jpg"} InfoUrl={""}/>
        </div>
        <div class="col">
